...
```{r}
ordered_pub_id_df <- psN2 %>% sample_data %>% dplyr::select(pub_id, rMDS1 = rMDS1.x.x, newname, MDS1 = MDS1.x.x) %>% arrange(rMDS1) %>% mutate(MDS1 = round(MDS1, 2), fig3tick = paste(pub_id, MDS1,sep = "_"))
ordered_pub_id_df
