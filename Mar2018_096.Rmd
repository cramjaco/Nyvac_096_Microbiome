...
psN1richP_gp41m6 <- psN1rich %>% sample_data %>% as.data.frame %>%
  ggplot(aes(x = MDS1, y = richEst, ymin = richLb, ymax = richUb, color = as.factor(medcode(IgG_gp41_Month_6.5)))) + geom_point() + geom_errorbar() + scale_y_log10()
psN1richP_gp41m6
```
...
psN1richP_p24m6 <- psN1rich %>% sample_data %>% as.data.frame %>%
  ggplot(aes(x = MDS1, y = richEst, ymin = richLb, ymax = richUb, color = as.factor(medcode2(IgG_p24_Month_6.5)))) + geom_point() + geom_errorbar() + scale_y_log10()
psN1richP_p24m6
